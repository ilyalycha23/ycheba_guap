...
SELECT 'корневые подразделения' AS выборка, д.*
FROM lr6_direct_subdepts(NULL) AS д;
SELECT 'дочерние у ид=1 (Промтех)' AS выборка, д.*
FROM lr6_direct_subdepts(1) AS д;
